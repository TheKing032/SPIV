...
class ObjectF : AppCompatActivity(), AdapterView.OnItemSelectedListener {
    ...
    override fun onItemSelected(parent: AdapterView<*>?, view: View?, position: Int, id: Long) {
        ...
        if (text == "Basement")
            imgView.setImageResource(R.drawable.f_pritlicje)
        else if(text == "First floor")
            imgView.setImageResource(R.drawable.f_nadstropje1)
